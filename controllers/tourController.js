...
//     // try{
//         // if we wanna put gte or something in url write property[gte]=xyz eg duration[gte]=5
...
// tours-within/233/center/-122.123133,322.5634533/unit/km
...
exports.getDistances = catchAsync( async (req, res, next) => {
    ...
    const distances = await Tour.aggregate([
        { // In geospatial shit geo near has to be 1st
            $geoNear: {
                near: {
                    type: 'Point',
