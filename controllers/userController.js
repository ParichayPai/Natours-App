...
exports.createUser = (req, res) => {
    res.status(500).json({
        status:"Error",
        message: "This route is not defined. Please use the Sign up page!!"
    })
}
...
exports.updateMe = catchAsync(async(req, res, next) => {
    ...
    if(req.body.password || req.body.passwordConfirm){
        return next(new AppError('This route is not for password change. User /updatePassword for it!', 400));
    }
