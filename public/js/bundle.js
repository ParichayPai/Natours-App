...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends map bounds, includes current locations
...
var stripe = Stripe('pk_test_51I7IErBXx3WNioRsI0vnwX4HU1dg95SaGnxr56s1JmulfkdF7chWJ3BLwT7AS1IDxIyGzpuC6fIJKS7iAFzZgvfj00zyVIBi42');
